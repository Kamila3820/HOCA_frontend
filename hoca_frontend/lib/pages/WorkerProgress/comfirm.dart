...
class _WorkerProgressPageState extends State<WorkerProgressPage> {
  ...
  context,
  PageTransition(
    type: PageTransitionType.rightToLeft, // Choose the transition type you want
    child: WorkerArrivalPage(orderID: orderID),
  ),
);
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.poppins(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: const Color.fromARGB(172, 0, 0,
                                  0), // Set the color of the text to match the icon if desired
                            ),
                          ),
                        ],
                      ),
                                ...
                                return AlertDialog(
                                  title: Row(
                                    children: [
                                      Icon(
                                        Icons
                                            .check_circle_outline, // Choose an appropriate icon
                                        color: const Color(
                                            0xFF87C4FF), // Icon color
                                      ),
                                      const SizedBox(
                                          width:
