...
class _ProgressPageState extends State<UserProgressPage>
...
Navigator.pushReplacement(
  ...
  PageTransition(
    ...
    child: UserArrivalPage(orderID: widget.orderID),
  ),
);
    }
  }
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return SingleChildScrollView(
                ...
                child: SizedBox(
                    // Set minimum height to screen height to ensure scrollability even when content is short
                        ...
                        Expanded(
                          child: Container(
                            margin: const EdgeInsets.only(
                                left: 20,
                                right: 20,
                                bottom: 130), // Adds a margin to the bottom
